...
public class SwingMain {
	...
	private void initialize() {
		...
		/*
		 * JButton btnVisualizarReservasComoSocio = new
		 * JButton("Ver reservas como socio");
		 * btnVisualizarReservasComoSocio.addActionListener(new ActionListener() {
		 * public void actionPerformed(ActionEvent e) {
		 * 
		 * VisualizarReservasComoSocioController controller = new
		 * VisualizarReservasComoSocioController(new
		 * VisualizarReservasComoSocioModel(),new VisualizarReservasComoSocioView());
		 * controller.initController(); } });
		 * frame.getContentPane().add(btnVisualizarReservasComoSocio);
		 */
